...
- **MCPを挿す**と、外の世界につながる
- 今日は<span class="term">Envato</span>（素材サイト）や**ブラウザ**をMCPで操作します
...
Gemini 2.5 Flash Image（通称 **nanobanana**）<br>
<span class="small">①静止画ショートで使用。取得：aistudio.google.com/apikey</span>

</div>
<div class="col">

### 🎞️ 動画素材
<span class="term">Pexels / Pixabay</span>
無料のストック動画API<br>
<span class="small">②素材ショートで使用。Envatoは有料で高品質</span>

</div>
<div class="col">

### 🗣️ 音声
<span class="term">IrodoriTTS</span>
ローカルで動くナレーション生成<br>
...
<span class="term">IrodoriTTS</span><span class="gloss">文章を“しゃべり声”に変える、手元で動く音声エンジン</span>
...
<span class="term">Remotion</span><span class="gloss">“コードで動画を組み立てる”仕組み。編集ソフトの代わり</span>
...
ただし**ライセンスは型ごと・素材ごと**に違う。Pexels/Pixabayは寛容だが、**最終確認は人間**。<br>
...
<div class="diagram">
  ...
  <div class="arrow">→</div>
  <div class="box"><b>文字起こし</b>Whisper<span class="small">秒単位の字幕データ</span></div>
  <div class="arrow">→</div>
